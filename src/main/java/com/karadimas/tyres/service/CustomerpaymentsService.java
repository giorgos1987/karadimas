    ...
    public Optional<Customerpayments> partialUpdate(Customerpayments customerpayments) {
        ...
        return customerpaymentsRepository
            ...
            .map(existingCustomerpayments -> {
                if (customerpayments.getTotalAmount() != null) {
                    existingCustomerpayments.setTotalAmount(customerpayments.getTotalAmount());
                }
                if (customerpayments.getRemainder() != null) {
                    existingCustomerpayments.setRemainder(customerpayments.getRemainder());
                }
                if (customerpayments.getDownPayment() != null) {
                    existingCustomerpayments.setDownPayment(customerpayments.getDownPayment());
                }
