...
public class JobCriteria implements Serializable, Criteria {
    ...
    private LongFilter jobCategoryId;
    ...
    public JobCriteria(JobCriteria other) {
        ...
        this.jobCategoryId = other.jobCategoryId == null ? null : other.jobCategoryId.copy();
    ...
    public LongFilter getJobCategoryId() {
        return jobCategoryId;
    }

    public LongFilter jobCategoryId() {
        if (jobCategoryId == null) {
            jobCategoryId = new LongFilter();
        }
        return jobCategoryId;
    }

    public void setJobCategoryId(LongFilter jobCategoryId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, price, priority, jobCategoryId, cartId, distinct);
    }
    ...
    public String toString() {
        return "JobCriteria{" +
            ...
            (jobCategoryId != null ? "jobCategoryId=" + jobCategoryId + ", " : "") +
