...
/**
 * Criteria class for the {@link com.karadimas.tyres.domain.Supplier} entity. This class is used
 * in {@link com.karadimas.tyres.web.rest.SupplierResource} to receive all the possible filtering options from
...
public class SupplierCriteria implements Serializable, Criteria {
    ...
    private LongFilter supplierpaymentsId;
    ...
    public SupplierCriteria(SupplierCriteria other) {
        ...
        this.supplierpaymentsId = other.supplierpaymentsId == null ? null : other.supplierpaymentsId.copy();
    ...
    public LongFilter getSupplierpaymentsId() {
        return supplierpaymentsId;
    }

    public LongFilter supplierpaymentsId() {
        if (supplierpaymentsId == null) {
            supplierpaymentsId = new LongFilter();
        }
        return supplierpaymentsId;
    }

    public void setSupplierpaymentsId(LongFilter supplierpaymentsId) {
        this.supplierpaymentsId = supplierpaymentsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(supplierpaymentsId, that.supplierpaymentsId) &&
    ...
    public String toString() {
        return "SupplierCriteria{" +
            ...
            (supplierpaymentsId != null ? "supplierpaymentsId=" + supplierpaymentsId + ", " : "") +
