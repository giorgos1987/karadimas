...
import com.karadimas.tyres.service.BookingQueryService;
import com.karadimas.tyres.service.BookingService;
...
/**
 * REST controller for managing {@link com.karadimas.tyres.domain.Booking}.
 */
@RestController
@RequestMapping("/api")
public class BookingResource {
     ...
     */
    @GetMapping("/bookings")
    public ResponseEntity<List<Booking>> getAllBookings(BookingCriteria criteria) {
        log.debug("REST request to get Bookings by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
        List<Booking> entityList = bookingQueryService.findByCriteria(criteria);
