...
import com.karadimas.tyres.service.CartQueryService;
...
/**
 * REST controller for managing {@link com.karadimas.tyres.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
     ...
     */
    @GetMapping("/carts")
    public ResponseEntity<List<Cart>> getAllCarts(CartCriteria criteria, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get Carts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countCarts(CartCriteria criteria) {
        log.debug("REST request to count Carts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
