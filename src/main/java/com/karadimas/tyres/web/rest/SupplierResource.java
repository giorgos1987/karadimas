...
import com.karadimas.tyres.service.SupplierQueryService;
import com.karadimas.tyres.service.SupplierService;
...
/**
 * REST controller for managing {@link com.karadimas.tyres.domain.Supplier}.
 */
@RestController
@RequestMapping("/api")
public class SupplierResource {
    ...
    public ResponseEntity<List<Supplier>> getAllSuppliers(
        ...
        log.debug("REST request to get Suppliers by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countSuppliers(SupplierCriteria criteria) {
        log.debug("REST request to count Suppliers by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
