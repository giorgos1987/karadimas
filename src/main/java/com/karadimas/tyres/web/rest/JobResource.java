...
import com.karadimas.tyres.service.JobQueryService;
...
/**
 * REST controller for managing {@link com.karadimas.tyres.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    public ResponseEntity<List<Job>> getAllJobs(JobCriteria criteria, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get Jobs by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countJobs(JobCriteria criteria) {
        log.debug("REST request to count Jobs by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
