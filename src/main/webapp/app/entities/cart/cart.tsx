          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="karadimastyresApp.cart.customers">Customers</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {cartList.map((cart, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{cart.customers ? <Link to={`/customers/${cart.customers.id}`}>{cart.customers.name}</Link> : ''}</td>
