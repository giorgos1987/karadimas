  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          customerDetails: cartEntity?.customerDetails?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('karadimastyresApp.cart.paymentReference')}
                id="cart-paymentReference"
              ...
              <ValidatedField
                id="cart-customerDetails"
                name="customerDetails"
                data-cy="customerDetails"
                label={translate('karadimastyresApp.cart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
