...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './neworders.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEWORDERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NEWORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEWORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEWORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEWORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEWORDERS actions', async () => {
      const expectedActions = [
        {
