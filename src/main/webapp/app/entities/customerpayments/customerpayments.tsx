          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('remainder')}>
                  <Translate contentKey="karadimastyresApp.customerpayments.remainder">Remainder</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="karadimastyresApp.customerpayments.customers">Customers</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {customerpayments.customers ? (
                      <Link to={`/customers/${customerpayments.customers.id}`}>{customerpayments.customers.name}</Link>
                    ) : (
                      ''
                    )}
                  </td>
