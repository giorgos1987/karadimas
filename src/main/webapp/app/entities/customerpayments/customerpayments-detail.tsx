    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="tax">
              <Translate contentKey="karadimastyresApp.customerpayments.tax">Tax</Translate>
            </span>
          </dt>
          <dd>{customerpaymentsEntity.tax}</dd>
          <dt>
            <span id="shipping">
              <Translate contentKey="karadimastyresApp.customerpayments.shipping">Shipping</Translate>
            </span>
          </dt>
          <dd>{customerpaymentsEntity.shipping}</dd>
          <dt>
            <span id="amountDue">
              <Translate contentKey="karadimastyresApp.customerpayments.amountDue">Amount Due</Translate>
            </span>
          </dt>
          <dd>{customerpaymentsEntity.amountDue}</dd>
          <dt>
            <span id="notes">
          ...
          <dd>{customerpaymentsEntity.customerDetails ? customerpaymentsEntity.customerDetails.name : ''}</dd>
        </dl>
