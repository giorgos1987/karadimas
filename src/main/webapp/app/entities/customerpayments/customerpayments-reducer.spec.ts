...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERPAYMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMERPAYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERPAYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERPAYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERPAYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERPAYMENTS actions', async () => {
      const expectedActions = [
        {
