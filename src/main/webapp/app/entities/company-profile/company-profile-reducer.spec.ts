...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYPROFILE actions', async () => {
      const expectedActions = [
        {
