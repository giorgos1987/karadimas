...
import { getEntity, deleteEntity } from './supplierpayments.reducer';
...
export const SupplierpaymentsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="karadimastyresApp.supplierpayments.delete.question">
        <Translate contentKey="karadimastyresApp.supplierpayments.delete.question" interpolate={{ id: supplierpaymentsEntity.id }}>
