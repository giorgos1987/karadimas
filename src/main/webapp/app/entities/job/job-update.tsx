...
import { getEntities as getJobCategories } from 'app/entities/job-category/job-category.reducer';
...
export const JobUpdate = () => {
  ...
  const jobCategories = useAppSelector(state => state.jobCategory.entities);
  ...
  const saveEntity = values => {
    const entity = {
      ...jobEntity,
      ...values,
      jobCategory: jobCategories.find(it => it.id.toString() === values.jobCategory.toString()),
    };
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="jobCategory"
                data-cy="jobCategory"
                label={translate('karadimastyresApp.job.jobCategory')}
                type="select"
                required
              >
                <option value="" key="0" />
                {jobCategories
                  ? jobCategories.map(otherEntity => (
