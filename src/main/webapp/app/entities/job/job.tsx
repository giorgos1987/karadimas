          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="karadimastyresApp.job.jobCategory">Job Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {jobList.map((job, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{job.jobCategory ? <Link to={`/job-category/${job.jobCategory.id}`}>{job.jobCategory.name}</Link> : ''}</td>
