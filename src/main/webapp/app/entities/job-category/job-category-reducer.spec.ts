...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBCATEGORY actions', async () => {
      const expectedActions = [
        {
