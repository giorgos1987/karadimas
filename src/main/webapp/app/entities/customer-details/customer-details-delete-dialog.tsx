...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="karadimastyresApp.customerDetails.delete.question">
        <Translate contentKey="karadimastyresApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
