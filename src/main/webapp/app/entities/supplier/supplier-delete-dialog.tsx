...
export const SupplierDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="karadimastyresApp.supplier.delete.question">
        <Translate contentKey="karadimastyresApp.supplier.delete.question" interpolate={{ id: supplierEntity.id }}>
